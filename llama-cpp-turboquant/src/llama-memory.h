...
struct llama_memory_i {
    ...
    // LLMTuning: access to layer-specific KV tensors
    virtual struct ggml_tensor * get_layer_k(int32_t /* il */) const { return nullptr; }
    virtual struct ggml_tensor * get_layer_v(int32_t /* il */) const { return nullptr; }
