...
extern "C" {
    ...
    struct llama_context_params {
        ...
        // TurboQuant high-performance flags
        bool  turbo_async;      // whether to use the 3-stage asynchronous pipeline
        float sparse_v_thresh;  // attention weight threshold for Sparse-V dequantization (<= 0 to disable)
